...
const TradingView = require('./js/main'); // Adjust the path as needed

const { appendAllDataFromJson } = require('./js/googleSheetsUtils');

const spreadsheetId = "1SZwDpZO7rvLenample-4tffr-KzhQB1JsPXBj8I"

const id = "whv5beenample-fwnaco9xq15dl7t";
const certificate = "v1:Bk/ZvaAmenample-rOeTdM9CTL+CUngWzYXUF0jvQ=";
